<footer class="xs-footer-section">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget xs-pr-20">
					...
					<ul class="xs-social-list-v2">
						...
						<li>
							<a href="" class="color-twitter"><i class="fa fa-twitter"></i></a>
						</li>
						<li>
				...
				<div class="col-lg-4 col-md-6 footer-widget">
					...
					<ul class="xs-info-list">
						<li>
							<i class="fa fa-home"></i>Sector # 48, 123 Street, miosya road VIC
							28, Australia.
						</li>
						<li>
							<i class="fa fa-phone"></i>(800) 123.456.7890 (800) 123.456.7890
							+00 99 88 5647
						</li>
						<li>
	...
	<div class="xs-back-to-top-wraper">
		<a href="#" class="xs-back-to-top" aria-label="To top"
